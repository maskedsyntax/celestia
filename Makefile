...
SRCS = $(SRC_DIR)/kinds.f90 \
       ...
       $(SRC_DIR)/io_utils.f90 \
       $(SRC_DIR)/profiler.f90 \
       $(SRC_DIR)/main.f90

# Object files (in order of dependency)
OBJS = kinds.o particle.o tree.o physics.o collisions.o initial_conditions.o io_utils.o profiler.o main.o
...
io_utils.o: $(SRC_DIR)/io_utils.f90 kinds.o particle.o
	$(FC) $(FFLAGS) -c $<

profiler.o: $(SRC_DIR)/profiler.f90
	$(FC) $(FFLAGS) -c $<

main.o: $(SRC_DIR)/main.f90 kinds.o particle.o tree.o physics.o collisions.o initial_conditions.o io_utils.o profiler.o
	$(FC) $(FFLAGS) -c $<
